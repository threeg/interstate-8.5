...
- **Write instructions, not arguments.** Every artefact here — a `spec/` rule, a ticket, a code comment,
  ...
  **act** on it, not by someone deciding whether to approve you. State the fact and leave out the case for it. The test: **could a builder act on this
  without being persuaded by it?**
