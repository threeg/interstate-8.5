# <PROJECT> — the requirements decisions
...
- **<DATE>** — `<FR-n>` — <the decision, the options considered, and why this one>.
- **<DATE>** — `<FR-n>` — amended in vX.Y.Z. Previously read: "<the exact superseded wording>".
  <Why it changed.>
