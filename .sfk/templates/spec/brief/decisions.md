# <PROJECT> — the brief decisions

| | |
|---|---|
| **Document** | Decision record and superseded wording for `brief.md` |
| **Repository location** | `spec/brief/decisions.md` |
| **Status** | **Archive — not binding.** The binding document is `brief.md` |
...
- **<DATE>** — `<goal / §n>` — <the decision, the options considered, and why this one>.
- **<DATE>** — `<goal / §n>` — amended in vX.Y.Z. Previously read: "<the exact superseded wording>".
  <Why it changed.>
