# <PROJECT> — the test strategy decisions
...
- **<DATE>** — `<§n / layer>` — <the decision, the options considered, and why this one>.
- **<DATE>** — `<§n / layer>` — amended in vX.Y.Z. Previously read: "<the exact superseded wording>".
  <Why it changed.>
