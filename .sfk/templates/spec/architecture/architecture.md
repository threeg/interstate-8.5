...
> docs, diagrams — into `spec/architecture/` beside this file. It informs the design but is *not*
...
> `depends_on` graph must respect the same ordering (see `spec/tickets/CONVENTIONS.md`).
