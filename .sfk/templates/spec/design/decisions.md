# <PROJECT> — the design system decisions
...
- **<DATE>** — `<token / component>` — <the decision, the options considered, and why this one>.
- **<DATE>** — `<token / component>` — amended in vX.Y.Z. Previously read: "<the exact superseded wording>".
  <Why it changed.>
