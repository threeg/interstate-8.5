...
| 28 | INT8-036 | Restore Firefox coverage in the Playwright suite (stale profile-lock symlink) and correct the record | task | tooling | 9 / cleanup | — | code | in-review | INT8-006, INT8-021 |
