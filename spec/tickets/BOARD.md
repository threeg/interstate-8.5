...
| C17 | [INT8-044](INT8-044-architecture-data-model-stale-cells.md) | Reconcile two stale cells in `architecture.md` §3.1's data-model table | task | docs | cleanup | | 👀 in-review | [INT8-010](INT8-010-song-content-type.md), [INT8-013](INT8-013-songs-migration.md) |
