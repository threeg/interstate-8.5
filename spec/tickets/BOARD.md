...
| C13 | [INT8-040](INT8-040-redirect-path-map-deferral-drift.md) | Qualify the v2→v5 redirect path-map claim in `api-contract.md` and `architecture.md` §6 | task | docs | cleanup | | 👀 in-review | [INT8-011](INT8-011-pathauto-songs.md) |
