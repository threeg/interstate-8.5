...
| C14 | [INT8-041](INT8-041-type-filter-published-terms.md) | Scope the Songs landing's Type-filter term lookup to published terms | task | services | cleanup | | 👀 in-review | [INT8-018](INT8-018-songs-landing.md), [INT8-035](INT8-035-move-entity-queries-out-of-the-theme.md) |
