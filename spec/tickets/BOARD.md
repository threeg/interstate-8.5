...
| C18 | [INT8-045](INT8-045-open-questions-register-first-rows.md) | Clear the open-questions template rows and record the song-type weight tie-break as `S-1` | task | docs | cleanup | | 👀 in-review | [INT8-041](INT8-041-type-filter-published-terms.md) |
