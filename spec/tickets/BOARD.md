...
| C11 | [INT8-038](INT8-038-ledger-sort-key-accent-folding.md) | Fold accents in the ledger's sort key so one letter cannot split into two groups | task | services | cleanup | | ⬜ todo | [INT8-029](INT8-029-ledger-letter-rail-grouping.md), [INT8-030](INT8-030-clickable-letter-rail.md) |
