...
| C15 | [INT8-042](INT8-042-fast-lint-only-gate.md) | Add a fast lint-only check alongside the default gate | task | tooling | cleanup | | 👀 in-review | [INT8-006](INT8-006-test-tooling-gate.md) |
