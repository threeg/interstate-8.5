...
| C12 | [INT8-039](INT8-039-i8-services-module-dependencies.md) | Declare `i8_services`' module dependencies and correct its stale description | task | services | cleanup | | 👀 in-review | [INT8-017](INT8-017-nav-frontpage.md), [INT8-035](INT8-035-move-entity-queries-out-of-the-theme.md) |
