# Interstate-8 — the brief decisions

| | |
|---|---|
| **Document** | Decision record and superseded wording for `brief.md` (and the per-version briefs beside it) |
| **Repository location** | `spec/brief/decisions.md` |
| **Status** | **Archive — not binding.** The binding documents are `brief.md` and the current version brief |
...
- **Decisions** — scope and goal decisions — why a goal was framed this way, why something was placed out of scope, which alternative framing was rejected. Record the options considered and the reason, not just the outcome.
...
_(No decisions recorded yet. This archive was created at the v1.4.7 kit update, 2026-08-08; the brief
has never carried a log, so nothing was moved into it. The `D-x` table in a version brief is a **live
list of decisions the version owes**, not a log, and stays where it is.)_
