...
- **Binds from the first ticket after 2026-08-08** (the v1.4.7 kit update). Tickets closed before that date
  predate the rule — do not report them, and do not backfill them.
